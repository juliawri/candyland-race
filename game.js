...
(function(){
  ...
  var QUESTIONS = [
    ...
    { q:"What is the most abundant gas in Earth's atmosphere?", options:['Oxygen','Nitrogen','Carbon dioxide','Argon'], answer:'Nitrogen' },
    { q:'Which vitamin deficiency causes scurvy?', options:['Vitamin A','Vitamin C','Vitamin D','Vitamin K'], answer:'Vitamin C' },
    { q:'Which scientist proposed the three laws of planetary motion?', options:['Newton','Kepler','Galileo','Copernicus'], answer:'Kepler' },
    { q:'Diamond and graphite are different forms of:', options:['Silicon','Carbon','Quartz','Calcium'], answer:'Carbon' },
    { q:'Which organelle is known as the "powerhouse of the cell"?', options:['Ribosome','Mitochondrion','Golgi apparatus','Nucleus'], answer:'Mitochondrion' },
    { q:'Which electromagnetic wave has the shortest wavelength?', options:['X-rays','Gamma rays','Ultraviolet','Radio waves'], answer:'Gamma rays' },
    { q:'Which country borders the most other countries?', options:['China','Russia','Brazil','India'], answer:'China' },
    { q:'Which African country has the largest population?', options:['Egypt','Nigeria','Ethiopia','South Africa'], answer:'Nigeria' },
    { q:'Which is the deepest ocean trench?', options:['Java Trench','Mariana Trench','Peru-Chile Trench','Tonga Trench'], answer:'Mariana Trench' },
    { q:'Which country is both in Europe and Asia?', options:['Turkey','Greece','Egypt','Morocco'], answer:'Turkey' },
    { q:'Which Canadian province has the largest population?', options:['British Columbia','Ontario','Quebec','Alberta'], answer:'Ontario' },
    { q:'Who was the first person to walk on the Moon?', options:['Buzz Aldrin','Neil Armstrong','Yuri Gagarin','Michael Collins'], answer:'Neil Armstrong' },
    { q:'Which empire was ruled by Genghis Khan?', options:['Ottoman','Mongol','Roman','Persian'], answer:'Mongol' },
    { q:'The Berlin Wall fell in:', options:['1985','1989','1991','1995'], answer:'1989' },
    { q:'Which civilization developed cuneiform writing?', options:['Egyptians','Sumerians','Greeks','Romans'], answer:'Sumerians' },
    { q:'Which explorer completed the first circumnavigation expedition?', options:['Christopher Columbus',"Ferdinand Magellan's expedition",'Vasco da Gama','James Cook'], answer:"Ferdinand Magellan's expedition" },
    { q:'The Rosetta Stone helped decipher:', options:['Latin','Egyptian hieroglyphs','Greek','Sanskrit'], answer:'Egyptian hieroglyphs' },
    { q:'A decagon has:', options:['8 sides','10 sides','12 sides','20 sides'], answer:'10 sides' },
    { q:'What does HTTP stand for?', options:['HyperText Transfer Protocol','High Transfer Text Protocol','HyperText Transmission Program','Host Transfer Protocol'], answer:'HyperText Transfer Protocol' },
    { q:'What does GPU stand for?', options:['Graphics Processing Unit','General Processing Utility','Graphic Program Unit','General Program Utility'], answer:'Graphics Processing Unit' },
    { q:'GDP stands for:', options:['General Domestic Production','Gross Domestic Product','Government Development Plan','Gross Development Policy'], answer:'Gross Domestic Product' },
    { q:'Which is generally considered a cryptocurrency?', options:['PayPal','Bitcoin','Visa','Venmo'], answer:'Bitcoin' },
    { q:'The word "alphabet" comes from:', options:['Latin numbers','The first two Greek letters (alpha and beta)','Egyptian symbols','Roman law'], answer:'The first two Greek letters (alpha and beta)' },
    { q:'Which language family includes English?', options:['Romance','Germanic','Slavic','Celtic'], answer:'Germanic' },
    { q:'Which kingdom do mushrooms belong to?', options:['Plantae','Fungi','Protista','Animalia'], answer:'Fungi' },
    { q:'DNA stands for:', options:['Deoxyribonucleic Acid','Dynamic Nuclear Acid','Double Nuclear Acid','Digital Nucleic Acid'], answer:'Deoxyribonucleic Acid' },
    { q:'Which animal is the largest reptile?', options:['Komodo dragon','Saltwater crocodile','Anaconda','Leatherback turtle'], answer:'Saltwater crocodile' },
    { q:'Photosynthesis primarily occurs in:', options:['Roots','Chloroplasts','Nucleus','Vacuoles'], answer:'Chloroplasts' },
    { q:'Sound cannot travel through:', options:['Air','Water','A vacuum','Steel'], answer:'A vacuum' },
    { q:"Earth's tectonic plates float on the:", options:['Inner core','Asthenosphere','Crust','Outer core'], answer:'Asthenosphere' },
    { q:'Which scale measures tornado intensity?', options:['Richter','Enhanced Fujita Scale','Saffir–Simpson','Beaufort'], answer:'Enhanced Fujita Scale' },
    { q:'El Niño is associated with:', options:['Atlantic hurricanes','Pacific Ocean temperature changes','Volcanoes','Earthquakes'], answer:'Pacific Ocean temperature changes' },
    { q:'Which country invented paper?', options:['Egypt','China','Greece','India'], answer:'China' },
    { q:'Which chess piece can never move diagonally?', options:['Bishop','Rook','Queen','King'], answer:'Rook' },
    { q:'Which is the only continent without native ants?', options:['Antarctica','Europe','Australia','South America'], answer:'Antarctica' },
    { q:'Which country has the most official languages?', options:['Canada','South Africa','Bolivia','India'], answer:'Bolivia' },
    { q:'Which planet rotates on its side?', options:['Saturn','Uranus','Mercury','Mars'], answer:'Uranus' },
    { q:'Which galaxy contains our Solar System?', options:['Andromeda','Milky Way','Whirlpool','Sombrero'], answer:'Milky Way' },
    { q:'Approximately how long does sunlight take to reach Earth?', options:['8 minutes','8 seconds','1 hour','24 minutes'], answer:'8 minutes' },
    { q:'Which language is primarily spoken in Brazil?', options:['Spanish','Portuguese','French','Italian'], answer:'Portuguese' },
    { q:'Which country has won the most FIFA Men\'s World Cups?', options:['Germany','Brazil','Italy','Argentina'], answer:'Brazil' },
    { q:'Which instrument measures atmospheric pressure?', options:['Thermometer','Barometer','Hygrometer','Anemometer'], answer:'Barometer' },
    { q:'Which organ produces insulin?', options:['Liver','Pancreas','Kidney','Stomach'], answer:'Pancreas' },
    { q:'Which branch of mathematics studies randomness?', options:['Algebra','Probability','Geometry','Calculus'], answer:'Probability' },
    { q:'Which artist painted the Mona Lisa?', options:['Michelangelo','Leonardo da Vinci','Raphael','Donatello'], answer:'Leonardo da Vinci' },
    { q:'Which country gifted the Statue of Liberty to the United States?', options:['Britain','France','Spain','Italy'], answer:'France' },
    { q:"Which ocean current helps moderate Western Europe's climate?", options:['Humboldt Current','Gulf Stream','California Current','Canary Current'], answer:'Gulf Stream' },
    { q:'Which famous theorem relates the sides of a right triangle?', options:['Binomial Theorem','Pythagorean Theorem','Fundamental Theorem of Calculus',"Bayes' Theorem"], answer:'Pythagorean Theorem' },
    { q:'Which scientist developed the theory of evolution by natural selection?', options:['Gregor Mendel','Charles Darwin','Louis Pasteur','Carl Linnaeus'], answer:'Charles Darwin' },
    { q:'Which language is primarily used to style web pages?', options:['HTML','CSS','SQL','Python'], answer:'CSS' },
    { q:'Which gas makes up most of the Sun?', options:['Oxygen','Hydrogen','Nitrogen','Helium'], answer:'Hydrogen' },
    { q:'Which mathematical constant is approximately 2.71828?', options:['π','e','φ','√2'], answer:'e' },
